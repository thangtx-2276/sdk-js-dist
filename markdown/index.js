...
function createRenderer(options) {
    ...
    md.use(katex_1.default, __assign({ throwOnError: true, strict: true }, _katexOptions));
    ...
    if (_options.embed !== false) {
        ...
        var embedPlugin = embed_1.createPlugin(__assign(__assign({}, embedOptions), { baseURL: _options.baseURL }));
        md.use(embedPlugin);
    }
